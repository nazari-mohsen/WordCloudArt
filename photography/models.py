...
class thumbnail(models.Model):
    ...
    category = models.ManyToManyField(Category, verbose_name=_('category'), related_name="thumbnail_photo")
    photo_Mask = models.OneToOneField(photo_Mask, verbose_name=_('photo_Mask'), on_delete=models.CASCADE, null=False)
    photo_main = models.OneToOneField(photo_main, verbose_name=_('photo_main'), on_delete=models.CASCADE, null=False)
    publish = models.DateTimeField(_('publish'), default=timezone.now)
    createDateTime = models.DateTimeField(_('create date'), auto_now=False, auto_now_add=True)
    updateDateTime = models.DateTimeField(_('update date'), auto_now=True, auto_now_add=False)
